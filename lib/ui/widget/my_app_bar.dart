...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    final Color _backgroundColor = Colours.app_bar_bg;
    ...
    final Widget back = isBack ? IconButton(
      ...
      icon: Image.asset(R.assetsImgIcWhiteBack, color: backImgColor,
      ),
    ) : Gaps.empty;
    ...
    final Widget titleWidget = Semantics(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: const TextStyle(fontSize: Dimens.font_sp18,color: Colours.text_white),
        ),
