...
final startTime = DateTime.parse('2018-05-16 08:21');
final endTime = DateTime.parse('2022-05-06 09:21');
...
class _MyDatePickerState extends State<MyDatePicker> {
  ...
  String stringIndexByYear(int index) {
    if (index >= -100 && index <= 100) {
      ...
      return MyDate.isInRange(_nowDate, start!, end!) ? _year.toString() + '年' : "";
    }
    return "";
  }
  ...
  String stringIndexByMonth(int index) {
    if (index >= 0 && index <= 11) {
      ...
      DateTime? end =  DateTime(2020, 1);

      return MyDate.isInRange(_nowDate, start, end) ? (index + 1).toString() + '月' : "";
    }
    return "";
  }
                    ...
                    return Container(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(fontSize: 18).copyWith(
                            color: Color(0xFF000046)), // theme.itemStyle,
